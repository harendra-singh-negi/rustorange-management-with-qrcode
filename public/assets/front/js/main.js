...
$.ajaxSetup({
    beforeSend: function (jqXHR, settings) {
        ...
        if (settings.type == 'POST' || settings.type == 'PUT') {
            ...
            toastr["warning"]('This is demo version. You cannot change anything here!')
            jqXHR.abort(event);
        }
    },
    complete: function () {
...
$(function() {
    ...
    $("#billing_country_code a").on('click',function (e){
        ...
        $(this).parents('.input-group').find('button.billing_country_code').text($(this).data('billing_country_code'));
    });
    $("#shipping_country_code a").on('click',function (e){
        e.preventDefault();
        $("input[name='shipping_country_code']").val($(this).data('shipping_country_code'));
        $(this).parents('.input-group').find('button.shipping_country_code').text($(this).data('shipping_country_code'));
    });
