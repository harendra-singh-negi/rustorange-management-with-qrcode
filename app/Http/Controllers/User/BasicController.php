...
class BasicController extends Controller
{
    ...
    public function specialSectionUpdate(Request $request, $langid)
    {
        $rules = [
            ...
            'special_section_bg' => new ImageMimeTypeRule(),
        ];
        ...
        if ($request->hasFile('special_section_bg')) {
            $be->special_section_bg = Uploader::update_picture(Constant::WEBSITE_IMAGE,$request->file('special_section_bg'),$be->special_section_bg);
        }
