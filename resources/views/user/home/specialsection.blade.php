                ...
                <div class="card-body pt-5 pb-4">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <form id="ajaxForm" action="{{route('user.special.section.update', $lang_id)}}"
                                  method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="showImage mb-3">
                                                <img
                                                    src="{{$abe->special_section_bg ? Uploader::getImageUrl(Constant::WEBSITE_IMAGE,$abe->special_section_bg, $userBs) : asset('assets/admin/img/noimage.jpg')}}"
                                                    alt="..." class="img-thumbnail" width="200">
                                            </div>
                                            <input type="file" name="special_section_bg" id="image"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="special_section_title" class="form-control"
                                           value="{{$abe->special_section_title}}">
                                    <p id="errspecial_section_title" class="em text-danger mb-0"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle **</label>
                                    <input name="special_section_subtitle" class="form-control"
                                           value="{{$abe->special_section_subtitle}}">
