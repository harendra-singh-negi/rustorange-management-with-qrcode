    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="" action="{{route('user.testimonialtext.update', $lang_id)}}" method="post"
                            ...
                            <div class="col-lg-6 offset-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 showImage mb-3">
                                        <img
                                            src="{{$abe->testimonial_bg_img ? Uploader::getImageUrl(Constant::WEBSITE_TESTIMONIAL_IMAGES,$abe->testimonial_bg_img,$userBs) : asset('assets/admin/img/noimage.jpg')}}"
                                    ...
                                    <table class="table table-striped mt-3">
                                        ...
                                        @foreach ($testimonials as $key => $testimonial)
                                            <tr>
                                                ...
                                                <td><img
                                                        src="{{Uploader::getImageUrl(Constant::WEBSITE_TESTIMONIAL_IMAGES,$testimonial->image,$userBs)}}"
                                                        alt="" width="40"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="deleteform d-inline-block"
                                                          action="{{route('user.testimonial.delete')}}" method="post">
                                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxForm" class="modal-form" action="{{route('user.testimonial.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>The higher the serial number is, the later the testimonial
