                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="showImage mb-3">
                              ...
                              @endif
                              <img src="{{Uploader::getImageUrl(Constant::WEBSITE_IMAGE,$abe->hero_bg,$userBs)}}" alt="..." class="img-thumbnail w-100" width="200">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="showImage mb-3">
                              ...
                              @endif
                              <img src="{{Uploader::getImageUrl(Constant::WEBSITE_IMAGE,$abe->hero_side_img,$userBs)}}" alt="..." class="img-thumbnail w-100" width="200">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="showImage mb-3">
                              ...
                              @endif
                              <img src="{{Uploader::getImageUrl(Constant::WEBSITE_IMAGE,$abe->hero_shape_img,$userBs)}}" alt="..." class="img-thumbnail w-100" width="200">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="showImage mb-3">
                              ...
                              @endif
                              <img src="{{Uploader::getImageUrl(Constant::WEBSITE_IMAGE,$abe->hero_bottom_img,$userBs)}}" alt="..." class="img-thumbnail w-100" width="200">
                            </div>
...
@section('scripts')
<script>
    let routeUrl = "{{route('user.herosection.rmv.img')}}";
    let currentUrl = "{{url()->current()}}";
    let langCode = "{{$abe->language->code}}";
</script>
