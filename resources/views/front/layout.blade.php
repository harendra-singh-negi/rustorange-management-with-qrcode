...
@if (!request()->routeIs('front.index') )
    ...
    <div class="page-title-area bg-img" data-bg-image="{{$bs->breadcrumb ? asset('assets/front/img/'.$bs->breadcrumb) : ''}}">
        <div class="container">
...
<script src="{{asset('assets/restaurant/js/script.js')}}"></script>
...
@if ($rtl == 1)
    ...
    <link rel="stylesheet" href="{{asset('assets/restaurant/js/rtl-script.js')}}">
@endif
...
@if ($bs->is_tawkto == 1)
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/{{$bs->tawkto_property_id}}/default';
            s1.charset='UTF-8';
