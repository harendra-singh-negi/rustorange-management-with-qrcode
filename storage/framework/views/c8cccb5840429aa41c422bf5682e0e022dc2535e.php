  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form id="ajaxForm" class="modal-form" action="<?php echo e(route('user.add.customer')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-12">
...
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/register_user/create_client.blade.php ENDPATH**/ ?>