                    ...
                    <tbody>
                        <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(($coupon->type == 'fixed' && $userBe->base_currency_symbol_position == 'left') ? $userBe->base_currency_symbol : ''); ?><?php echo e($coupon->value); ?><?php echo e($coupon->type == 'percentage' ? '%' : ''); ?><?php echo e(($coupon->type == 'fixed' && $userBe->base_currency_symbol_position == 'right') ? $userBe->base_currency_symbol : ''); ?></td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <a href="<?php echo e(route('user.coupon.edit', $coupon->id)); ?>" class="btn btn-warning my-2 btn-sm">Edit</a>
                                    <form class="d-inline-block deleteform" action="<?php echo e(route('user.coupon.delete')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="ajaxForm" class="modal-form" action="<?php echo e(route('user.coupon.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Minimum Spend (<?php echo e($userBe->base_currency_text); ?>)</label>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/product/order/coupons/index.blade.php ENDPATH**/ ?>