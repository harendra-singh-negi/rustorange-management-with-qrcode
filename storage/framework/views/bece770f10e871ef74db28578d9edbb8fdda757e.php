...
<div class="card">
    ...
    <form id="ajaxForm" action="<?php echo e(route('user.reservation.form.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/reservations/create-input.blade.php ENDPATH**/ ?>