    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('user.timeframe.store')); ?>" id="ajaxForm" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/product/order/delivery_time/create.blade.php ENDPATH**/ ?>