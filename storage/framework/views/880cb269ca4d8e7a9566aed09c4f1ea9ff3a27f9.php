  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="" action="<?php echo e(route('user.role.update')); ?>" method="POST">
          <?php echo csrf_field(); ?>
...
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/role/edit.blade.php ENDPATH**/ ?>