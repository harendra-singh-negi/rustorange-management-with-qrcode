    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="<?php echo e(route('user.email.templates')); ?>">
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-6">
                <table class="table table-striped mb-5">
                    ...
                    <tbody>
                        ...
                        <?php if($template->mail_type == 'reset_password'): ?>
                            <tr>
                                <td>
                                    {password_reset_link}
                                </td>
                        ...
                        <?php endif; ?>
                        <?php if($template->mail_type == 'email_verification' || $template->mail_type == 'verify_email'): ?>
                        <tr>
                            <td>
                              {verification_link}
                            </td>
                        ...
                        <?php if($template->mail_type == 'order_received' ||
            ...
            <div class="col-lg-6">
               <form id="ajaxForm" action="<?php echo e(route('user.email.templateUpdate', $template->id)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="mail_type" placeholder="Email Type" value="<?php echo e($etype); ?>" readonly>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="mail_subject"  placeholder="Email Subject" value="<?php echo e($template->mail_subject); ?>">
                ...
                <div class="row">
                   <div class="col-lg-12">
                      <div class="form-group">
                         ...
                         <textarea class="form-control summernote" name="mail_body" placeholder="Enter description" id="mail_body" data-height="300"><?php echo e($template->mail_body); ?></textarea>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/basic/email/templates/edit.blade.php ENDPATH**/ ?>