<script>
  ...
  var pusherAppKey = "<?php echo e($be->pusher_app_key ?? ''); ?>";
  var pusherCluster = "<?php echo e($be->pusher_app_cluster ?? ''); ?>";
...
<script src="<?php echo e(asset('assets/admin/js/plugin/tinymce/js/tinymce/tinymce.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/js/atlantis.min.js')); ?>"></script>

<?php if(!is_null($be->pusher_app_key) && !is_null($be->pusherCluster)): ?>
...
<?php endif; ?>
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/admin/partials/scripts.blade.php ENDPATH**/ ?>