        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-6 mt-2 mt-lg-0">
                    <button class="btn btn-danger float-right btn-sm ml-2 mt-1 d-none bulk-delete" data-href="<?php echo e(route('user.subscriber.bulk.delete')); ?>"><i class="flaticon-interface-5"></i> <?php echo e(__('Delete')); ?></button>
                    ...
                    <tbody>
                      <?php $__currentLoopData = $subscs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subsc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <form class="deleteform d-inline-block" action="<?php echo e(route('user.subscriber.delete')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/subscribers/index.blade.php ENDPATH**/ ?>