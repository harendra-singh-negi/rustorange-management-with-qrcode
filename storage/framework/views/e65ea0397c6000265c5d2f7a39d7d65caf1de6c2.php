  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('user.change.customer.password')); ?>" method="POST">
...
<?php /**PATH /home/cpftxworld/myludhiana.in/resources/views/user/register_user/change_password.blade.php ENDPATH**/ ?>